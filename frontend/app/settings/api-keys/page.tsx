  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="mx-auto w-full max-w-2xl flex-1 px-6 py-10">
        <h1 className="text-2xl font-bold tracking-tight text-brand-navy dark:text-foreground">API keys</h1>
        <p className="mt-1 text-sm text-muted">Use a key with the <code>X-API-Key</code> header to call the API directly.</p>

        {revealedKey && (
          <div className="mt-6 rounded-2xl border border-brand-amber/40 bg-brand-amber-soft p-4 dark:border-brand-amber/30 dark:bg-brand-navy-soft">
            <p className="text-sm font-medium text-brand-amber-dark dark:text-brand-amber">
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <button
                onClick={handleCopy}
                className="shrink-0 rounded-lg border border-brand-amber/50 px-3 py-2 text-sm font-medium text-brand-amber-dark transition-colors hover:bg-white/60 dark:text-brand-amber"
              >
                {copied ? "Copied" : "Copy"}
              </button>
            </div>
            <button
              ...
              className="mt-3 text-sm text-brand-amber-dark underline dark:text-brand-amber"
            >
              Done, I&apos;ve saved it
            </button>
          </div>
